...
- **Global scope**: `/home/wihan/Projects/clinic-atlas/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/wihan/Projects/clinic-atlas/.claude/notes/`)
...
2. Glob `/home/wihan/Projects/clinic-atlas/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/wihan/Projects/clinic-atlas/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/wihan/Projects/clinic-atlas/.claude/notes/` — works in any directory
