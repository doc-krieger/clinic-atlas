...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/wihan/Projects/clinic-atlas/.claude
                  → checks /home/wihan/Projects/clinic-atlas/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/wihan/Projects/clinic-atlas/.claude/get-shit-done
                  → writes to /home/wihan/Projects/clinic-atlas/.claude/get-shit-done/hooks/
...
@/home/wihan/Projects/clinic-atlas/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/wihan/Projects/clinic-atlas/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/wihan/Projects/clinic-atlas/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/wihan/Projects/clinic-atlas/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/wihan/Projects/clinic-atlas/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
