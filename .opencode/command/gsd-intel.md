...
Intel system is disabled. To activate:
  ...
  node /home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs
