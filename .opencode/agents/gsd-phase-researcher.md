...
```bash
node "/home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/wihan/Projects/clinic-atlas/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
